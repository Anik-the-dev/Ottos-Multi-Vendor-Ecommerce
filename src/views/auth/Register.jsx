                ...
                <div className='bg-[#283046] p-4 rounded-md'>
                    ...
                    <form>
                        ...
                        <div className='flex flex-col w-full gap-1 mb-3'>
                            ...
                            <input className='px-3 py-2 outline-none border border-slate-700 bg-transparent rounded-md text-[#d0d2d6] focus:border-indigo-500 overflow-hidden' type="email" name='email' placeholder='email' id='email' required />
                        </div>
                        <div className='flex flex-col w-full gap-1 mb-3'>
